	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv019 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult26 = lerp( _ColorUP , _ColorBotton , uv019.y);
				...
				surfaceDescription.Normal = UnpackNormalmapRGorAG( tex2D( _NormalMap, uv_NormalMap3 ), _Normal );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv019 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float4 lerpResult26 = lerp( _ColorUP , _ColorBotton , uv019.y);
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_RoughnessMap6 = packedInput.interp03.xy;
...
/*ASEBEGIN
Version=17800
1;111;1466;866;1131.349;719.3293;1.673801;True;True
Node;AmplifyShaderEditor.ColorNode;24;-984.7195,-781.4845;Float;False;Property;_ColorBotton;Color Botton;3;0;Create;True;0;0;False;0;0,0.5862069,1,0;0.7379313,0,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;6;-434.1115,72.71856;Inherit;True;Property;_RoughnessMap;Roughness Map;6;1;[NoScaleOffset];Create;True;0;0;False;0;-1;4086b8dcbe0f5e047b4196c8af0ec18e;032041785d709854689604b2da519739;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;23;-994.1869,-964.9598;Float;False;Property;_ColorUP;Color UP;2;0;Create;True;0;0;False;0;1,0,0,0;1,0.3602941,0.3602941,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;2;-401.722,448.6696;Inherit;True;Property;_EmmisionMap;Emmision Map;9;1;[NoScaleOffset];Create;True;0;0;False;0;-1;fde12f945b57b1447a494da606565cb6;fde12f945b57b1447a494da606565cb6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;9;-386.342,270.701;Float;False;Property;_Emission;Emission;10;1;[HDR];Create;True;0;0;False;0;1,0.03676468,0.03676468,0;1,0,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1;-575.342,-546.5634;Inherit;True;Property;_DiffuseMap;Diffuse Map;1;1;[NoScaleOffset];Create;True;0;0;False;0;-1;None;633ae744fc914834c900da9a9fb235d7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;3;-503.6438,-313.3155;Inherit;True;Property;_NormalMap;Normal Map;4;2;[NoScaleOffset];[Normal];Create;True;0;0;False;0;-1;61a227fe1b2fc3444a5190b3f76343af;dbe6103765b532e4481c64b1c6db6ee9;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=D4B1B3141379FAD6716A96997022C54CFC5D8EA9